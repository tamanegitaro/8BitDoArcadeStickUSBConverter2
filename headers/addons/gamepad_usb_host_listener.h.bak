...
// 8BitDo arcade stick report
typedef struct TU_ATTR_PACKED
{
    uint8_t  reportId;                                 // Report ID = 0x30 (48)
    int8_t   : 8;                                      // Pad
    int8_t   : 8;                                      // Pad
    uint8_t  BTN_GamePadButton1  : 1;                  // Usage B3
    uint8_t  BTN_GamePadButton2  : 1;                  // Usage B4
    uint8_t  BTN_GamePadButton3  : 1;                  // Usage B1
    uint8_t  BTN_GamePadButton4  : 1;                  // Usage B2
    int8_t   : 1;                                      // Pad
    int8_t   : 1;                                      // Pad
    ...
    uint8_t  BTN_GamePadButton13 : 1;                  // Usage L2
    uint8_t  : 4;                                      // Pad
    uint8_t  GD_GamePadPointerXl : 4;                  // Usage X, Value = 0 to 255
    uint8_t  GD_GamePadPointerXh : 4;                  // Usage X, Value = 0 to 255
    uint8_t  : 4;                                      // Pad
    uint8_t  GD_GamePadPointerY;                       // Usage Y, Value = 0 to 255
    uint8_t  : 4;                                      // Pad
    uint8_t  GD_GamePadPointerZl : 4;                  // Usage Z, Value = 0 to 255
    uint8_t  GD_GamePadPointerZh : 4;                  // Usage Z, Value = 0 to 255
    uint8_t  : 4;                                      // Pad
    uint8_t  GD_GamePadPointerRz;                      // Usage Rz, Value = 0 to 255
